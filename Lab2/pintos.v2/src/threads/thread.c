...
bool comp(struct list_elem* given,struct list_elem* thispoint,void* aux UNUSED){
  struct thread *t = list_entry (thispoint, struct thread, elem);
  struct thread *g = list_entry (given, struct thread, elem);
