...
struct thread
  {
    ...
    bool donated;                       /* v3 Donated or not*/
		struct lock *blocked;               /* 记录阻塞当前线程的锁 */
...
bool cmp_thread (const struct list_elem* thread1, const struct list_elem* thread2, void *aux);
bool cmp_lock (const struct list_elem* lock1, const struct list_elem* lock2, void *aux);
bool cmp_sema (const struct list_elem* sema1, const struct list_elem* sema2, void *aux);
